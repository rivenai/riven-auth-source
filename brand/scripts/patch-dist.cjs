...
const codeSafeReplacements = [
  ...
  { from: /Logto-Static-Package/gi, to: 'Riven-Static-Package' },
  { from: /Logto-App-Id/gi, to: 'Riven-App-Id' },
  { from: /Logto-Core-Request-Id/gi, to: 'Riven-Core-Request-Id' },
  { from: /urn:logto:/gi, to: 'urn:riven:' },
  { from: /x-logto-cf-/gi, to: 'x-riven-cf-' },
