...
<NpmLikeInstallation packageName="@riven/react" />
...
<Code className="language-tsx" title="App.tsx">
    {`import { LogtoProvider, type LogtoConfig } from '@riven/react';
...
import { useHandleSignInCallback } from '@riven/react';
...
import { useLogto, type IdTokenClaims } from '@riven/react';
